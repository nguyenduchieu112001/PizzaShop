...
@Service
public class ReservationDtoMapper implements Function<Reservation, ReservationOutput> {

	@Autowired
	private ICustomerRepository customerRepository;

	@Override
	public ReservationOutput apply(Reservation t) {
		...
		return new ReservationOutput(t.getId(), t.getReservationCode(), t.getCreatedAt(), t.getReservationDate(),
