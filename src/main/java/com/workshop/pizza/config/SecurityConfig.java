	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeHttpRequests()
				.requestMatchers("/api/v1/customer/authenticate", "/api/v1/customer/register", "/images/**",
						...
						"/api/v1/customer/find-by-email", "/api/v1/customer/forgot-password/{id}",
				...
				.requestMatchers("/api/v1/admin/sign-up", "/api/v1/bill/**", "/api/v1/reservation/**",
						...
						"/api/v1/customer/change-information/{id}", "/api/v1/customer/change-password", "/api/v1/product/**", "/api/v1/product-type/**",
